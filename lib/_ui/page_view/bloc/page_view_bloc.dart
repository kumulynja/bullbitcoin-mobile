...
class PageViewBloc extends Bloc<PageViewEvent, PageViewState> {
  ...
  PageViewBloc({required this.totalPages})
      : super(const PageViewState(
            currentPage: 0, status: PageViewStatus.initial)) {
  ...
  void _onNextPagePressed(
      PageViewNextPagePressed event, Emitter<PageViewState> emit) {
  ...
  void _onPreviousPagePressed(
      PageViewPreviousPagePressed event, Emitter<PageViewState> emit) {
